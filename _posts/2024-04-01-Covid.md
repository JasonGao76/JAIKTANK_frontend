    ...
    <script>
        document.getElementById('covidForm').addEventListener('submit', function(e) {
            ...
            fetch("http://localhost:8086/api/covid/predict_risk_level", requestOptions)
                ...
                .then(result => {
                    console.log(result);
                    document.getElementById('result').textContent = result.risk_level; // this display with accessing the correct value isnt working properly f, but the data is being output to console properly
                    }
                )
